...
export const SwapCard = ({ children }: { children: React.ReactNode }) => {
  return (
    <div
      ...
      style={{
        background: `
          ...
          radial-gradient(106.67% 33.21% at 48.7% -4.01%, rgba(212, 47, 197, 0.7) 0%, rgba(125, 230, 229, 0) 100%),
          radial-gradient(91.86% 28.6% at 50.14% 51.59%, rgba(212, 47, 197, 0.4) 0%, rgba(125, 230, 229, 0) 100%)
        `,
